...
@router.post("/inputs/add", status_code=status.HTTP_201_CREATED, response_model=str)
async def add_question(
    ...
    **Note**: This does not yet create active questions in the main pool.
    Use the promotion endpoint to finalize these drafts after review.

    Args:
        num_of_questions (int): Number of questions to be generated by the AI.
        question_input_data (QuestionInputCreate): The source material and metadata.
        question_manager (QuestionManager): Injected manager handling the logic.
    ...
    """
    return question_manager.add_question_input(
        num_of_questions,
        question_input_data
    )
